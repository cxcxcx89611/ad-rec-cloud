...
public class AdUnitOPController {
    ...
    public AdUnitResponse createUnit(@RequestBody AdUnitRequest adUnitRequest) throws AdException {
        log.info("ad-sponsor:  createUnit -> {}", JSON.toJSONString(adUnitRequest));
    ...
    public AdUnitDistrictResponse createUnitDistrict(@RequestBody AdUnitDistrictRequest request) throws AdException {
        log.info("ad-sponsor:  create unit district -> {}", JSON.toJSONString(request));
    ...
    public CreativeUnitResponse createCreativeUnit(@RequestBody CreativeUnitRequest request) throws AdException {
        log.info("ad-sponsor:  create creative unit -> {}", JSON.toJSONString(request));
